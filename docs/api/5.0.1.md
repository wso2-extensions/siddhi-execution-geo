...
### findCityFromIP *<a target="_blank" href="http://siddhi.io/documentation/siddhi-5.x/query-guide-5.x/#function">(Function)</a>*

<p style="word-wrap: break-word">This function returns the city that is related to the given IP address.</p>
...
### findCountryFromIP *<a target="_blank" href="http://siddhi.io/documentation/siddhi-5.x/query-guide-5.x/#function">(Function)</a>*
...
insert into OutputStream;
```
<p style="word-wrap: break-word">This query returns the country corresponding to the given IP address.</p>

### geocode *<a target="_blank" href="http://siddhi.io/documentation/siddhi-5.x/query-guide-5.x/#stream-function">(Stream Function)</a>*
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">The basic location details. For example the Street name, number etc..</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">The location details including the longitude and the latitude of the location.</td>
        <td style="vertical-align: top">STRING</td>
    </tr>
</table>
...
### geocoordinate *<a target="_blank" href="http://siddhi.io/documentation/siddhi-5.x/query-guide-5.x/#stream-function">(Stream Function)</a>*

<p style="word-wrap: break-word">The geocoordinate stream function returns the longitude and latitude values of a location relating to a given IPV4 or IPV6 address.</p>
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">ip</td>
        <td style="vertical-align: top; word-wrap: break-word">The IP address for which the user needs the longitude and latitude values.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">ipInfoDB(https://www.ipinfodb.com/) provides an API toget information relating to an IP address based on their geolocation database.This API provides a URL to get the latitude and longitude of a given IP address.</td>
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">longitude</td>
        <td style="vertical-align: top; word-wrap: break-word">The longitude of the location corresponding to the given IP.</td>
        <td style="vertical-align: top">DOUBLE</td>
    </tr>
    <tr>
        <td style="vertical-align: top">latitude</td>
        <td style="vertical-align: top; word-wrap: break-word">The latitude of the location corresponding to the given IP.</td>
        <td style="vertical-align: top">DOUBLE</td>
    </tr>
</table>
...
```
<p style="word-wrap: break-word">This returns the longitude and the latitude of the given IPV4 or IPV6 address. The results for the geocoordinate(95.31.18.119) are 55.7522 and 37.6156.</p>

### reversegeocode *<a target="_blank" href="http://siddhi.io/documentation/siddhi-5.x/query-guide-5.x/#stream-function">(Stream Function)</a>*
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">longitude</td>
        <td style="vertical-align: top; word-wrap: break-word">The longitude value required in order to derive at the location.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">DOUBLE</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
    ...
    <tr>
        <td style="vertical-align: top">latitude</td>
        <td style="vertical-align: top; word-wrap: break-word">The latitude value required in order to derive at the location.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">DOUBLE</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
